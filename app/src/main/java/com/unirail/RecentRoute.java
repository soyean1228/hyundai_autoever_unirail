...
public class RecentRoute extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor.getCount() == 0){
            ...
            cursor =db.rawQuery("SELECT TIME,STARTSTATION,FINALSTATION,STARTLINENUM,STARTRAILLINKLISTNUM,MIDDLESTATION0,MIDDLESTATION1,MIDDLESTATION2,MIDDLELINENUM0,MIDDLELINENUM1,MIDDLELINENUM2,MIDDLERAILLINKLISTNUM0,MIDDLERAILLINKLISTNUM1,MIDDLERAILLINKLISTNUM2 FROM ROUTESTATION", null);
            cursor.moveToFirst();
